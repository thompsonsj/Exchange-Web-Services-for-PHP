...
class ExchangeClient {
  ...
  public function get_events($start, $end) {
    ...
    $response = $this->client->FindItem( $this->array_to_object( $FindItem ) );
  ...
  public function delete_event(
    ...
    $response = $this->client->DeleteItem( $this->array_to_object( $DeleteItem ) );
    $this->teardown();
  ...
  public function array_to_object( $d ) {
    if ( is_array( $d )) {
      return (object) array_map( array( $this, 'array_to_object'), $d );
    }
    else {
      return $d;
    }
